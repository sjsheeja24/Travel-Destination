...
const Tours = () => {
    const tours = [
    { name: 'Bali', image: process.env.PUBLIC_URL + '/images/bali.jpg' },
    { name: 'Rome', image: process.env.PUBLIC_URL + '/images/rome.webp' },
    { name: 'Santorini', image: process.env.PUBLIC_URL + '/images/santorini.webp' },
  ];
