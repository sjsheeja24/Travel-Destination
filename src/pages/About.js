...
const About = () => {
    const places = [
        { name: 'Paris', image: process.env.PUBLIC_URL + '/images/baibeach.jpg' },
        { name: 'Tokyo', image: process.env.PUBLIC_URL + '/images/tokyo.webp' },
        { name: 'New York', image: process.env.PUBLIC_URL + '/images/newyork.webp' },
        { name: 'Varkala', image: process.env.PUBLIC_URL + '/images/varkala.webp' },
        { name: 'Munnar', image: process.env.PUBLIC_URL + '/images/munnar.jpg' },
        { name: 'Wayanad', image: process.env.PUBLIC_URL + '/images/wayanad.webp' },
      ];
    ...
    <section className="relative min-h-screen text-white" id="about">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-[-1]">
        <video className="w-full h-full object-cover" autoPlay muted loop>
          <source src={process.env.PUBLIC_URL + "/videos/kerala.mp4"} type="video/mp4" />
